/*
    ...
    Charity token with tokenomics that incentivises people to HODL.
    For the HODLers
*/
...
contract dusktoken is Context, IERC20, Ownable {
    ...
    string private _name = "Dusk Token";
    string private _symbol = "DUSK";
    ...
    address payable public charityAddress = 0xC37E58E0b2d9E3c9e8a9316e0Ab331f5c13fF701; // Charity Wallet Address
